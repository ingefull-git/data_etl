...
def test_log_decorator_class_logger_from_class_405():
    ...
    loggerps = LoggerGeneric(name='TESTS', formatter=BASIC_FORMAT, log_level='DEBUG', file_name='test_debug.log')
...
def test_log_decorator_class_logger_from_parameter_407(global_config):
    ...
    @debuglog()
    def to_decorate(retries=5, backoff_factor=2, status_forcelist=(500, 502, 503, 504), logger=None):
        response = requests.Response()
